...
import com.example.Adapter.TuVungGTAdapter;
import com.example.Database.SQLiteConnect;
import com.example.Model.TuVungGhepTu;
import com.example.activities.ThemMoiTuActivity;
...
public class QuanLiTuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quan_li_tu);
        ...
        imbtnGame.setOnClickListener(v -> {
            startActivity(new Intent   (QuanLiTuActivity.this, MainActivity.class));
            finish();
        ...
        String query = "CREATE TABLE IF NOT EXISTS tuvungGT (" +
        ...
        tuVungGTAdapter = new TuVungGTAdapter(QuanLiTuActivity.this, R.layout.item_quan_li, listTu);
    ...
    public void loadDataTuVung(){
        String query = "SELECT * FROM tuvungGT";
